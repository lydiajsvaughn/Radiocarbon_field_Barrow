...
field includes all C13 and non-atmosphere-corrected C14 data
chambers lists the names of samples for which CO2 concentrations were greater than 10x atmosphere
```{r}
field <- read.csv('data/field.csv', header=T, sep=',', stringsAsFactors=F)
...
Use f_soil values to correct measured 14C values for the atmospheric fraction
```{r}
