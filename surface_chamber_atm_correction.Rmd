...
Data: field includes all C13 and non-atmosphere-corrected C14 data, available at http://dx.doi.org/10.5440/1364062
chambers is a vector listing the names of samples for which CO2 concentrations were greater than 10x atmosphere
```{r}
